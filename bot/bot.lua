bot = dofile('/home/bot6/inline/data/utils.lua')
json = dofile('/home/bot6/inline/data/JSON.lua')
      ...
      for i=0 , #bots do
       ...
       bot.channel_get_bots(msg.chat_id_,cb)
          ...
          bot.sendMessage(msg.chat_id_, msg.id_, 1,'<code>>لینک تنظیم شده با موفقیت بازنشانی گردید.</code>', 1, 'html')
            ...
            if text and text:match('^تنظیم نام گپ (.*)') then
            local name = text:match('^تنظیم نام گپ (.*)')
...
-- mods
    ...
    if text == 'مدیران' or text == 'مدیرین' then
      ...
      if text == 'حذف مدیران' or text == 'حذف لیست مدیران' then
    ...
    if msg_type == 'text' then
      ...
      if text:match('^چه کسی @(.*)') then
	   ...
	   bot.sendMessage(msg.chat_id_, msg.reply_to_message_id_, 1, "<code>>پیام مورد نظر شما پین شد.</code>", 1, 'html')
			 ...
			 if text == 'ربات' then
          bot.sendMessage(msg.chat_id_, msg.id_, 1,'<b>آنلاینم عزیزم!</b>', 1, 'html')
      end
