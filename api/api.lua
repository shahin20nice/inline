    ...
    return false
		...
		local keyboard = {}
				 ...
				 {text = '⁉️سوالات متداول♨️', callback_data = 'soalatmotadavel:'..chat}
                   ...
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'helpbot:'..chat}
				}
							}
		...
		local keyboard = {}
                   ...
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'groupinfo:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'managerlist:'..chat}
				}
							}
              edit(q.inline_message_id,'`با عرض پوزش،در حال حاضر سیستم انتخابی غیرفعال میباشد.`',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'ownerlist:'..chat}
				}
							}
              edit(q.inline_message_id,'`با عرض پوزش،در حال حاضر سیستم انتخابی غیرفعال میباشد.`',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'banlist:'..chat}
				}
							}
              edit(q.inline_message_id,'`با عرض پوزش،در حال حاضر سیستم انتخابی غیرفعال میباشد.`',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'silentlistusers:'..chat}
				}
							}
              edit(q.inline_message_id,'`با عرض پوزش،در حال حاضر سیستم انتخابی غیرفعال میباشد.`',keyboard)
            end
		...
		local keyboard = {}
				 ...
				 {text = '❌خیر', callback_data = 'as12310fklfkmgfvm:'..chat},{text = '✅بله', callback_data = '3kj5g34ky6g34uy:'..chat}
                   ...
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'showrules:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'linkgroup:'..chat}
				}
							}
		...
		local keyboard = {}
				 ...
				 {text = '❌خیر', callback_data = 'ncxvbcusxsokd9374uid:'..chat},{text = '✅بله', callback_data = 'erewigfuwebiebfjdskfbdsugf:'..chat}
                   ...
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'filterlistword:'..chat}
				}
							}
		...
		local keyboard = {}
                   ...
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'salegroup:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'promanage:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'normalmanage:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '📋منو اصلی🌍', callback_data = 'firstmenu:'..chat},{text = '⬅️صفحه قبل🔙', callback_data = 'herfeiimanage:'..chat}
				}
							}
            	...
            	keyboard.inline_keyboard = {
                 ...
                 {text=getsettings('username'),callback_data=chat..':lock username'}, {text = '🎗تگ🆔', callback_data = chat..'_username'}
                  ...
                  {text=getsettings('contact'),callback_data=chat..':lock contact'},{text = '☎️مخاطب📞', callback_data = chat..'_contact'}
                   ...
                   {text = '📋منو اصلی🌍◀️', callback_data = 'firstmenu:'..chat},{text = '▶️ صفحه بعدی', callback_data = 'next_page:'..chat}
                }
							}
